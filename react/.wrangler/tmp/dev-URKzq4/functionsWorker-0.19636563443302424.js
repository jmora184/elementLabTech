...
// .wrangler/tmp/pages-wfcgFv/functionsWorker-0.19636563443302424.mjs
...
async function onRequestPost10({ request, env }) {
  try {
    ...
    if (existing?.id) {
      return json16({ ok: true, duplicate: true, purchaseId: existing.id });
    }
    ...
    return json16({ ok: true, inserted: true, id: result?.meta?.last_row_id || null });
  } catch (err) {
...
// .wrangler/tmp/bundle-UJsgtf/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-UJsgtf/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.19636563443302424.js.map
